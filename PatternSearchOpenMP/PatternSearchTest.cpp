...
void TestPatternSearch()
{
    ...
    std::cout << "Test 1 -> A(1,9) B(5,0)" << std::endl;
    img.print();
    ...
    std::cout << "Test 2 -> A(1,5) B(5,1)" << std::endl;
    img.print();
    ...
    std::cout << "Test 3 -> A(9,5) B(1,6)" << std::endl;
    img.print();
    ...
    std::cout << "Test 4 -> A(4,10) B(3,1)" << std::endl;
    img.print();
...
void TestSerialPatternSearch(Image& img)
{
    ...
    std::cout << "Serial pattern average search time in 1000 iterations: "
...
void TestParallelPatternSearchMethod_1(Image& img)
{
    ...
    pattern_search::printResults(results);
    std::cout << "OMP Method-1 average search time in 1000 iterations: "
        << (sum / iterationCount) * 1000.0
        << " ms\n" << std::endl;
